...
<div class="container mt-5">
    ...
    <nav>
        <ul class="pagination justify-content-center">
            <?php if ($page > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="obituaries.php?page=<?php echo ($page - 1) . "&search=" . urlencode($search); ?>">Previous</a>
                </li>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                    <a class="page-link" href="obituaries.php?page=<?php echo $i . "&search=" . urlencode($search); ?>"><?php echo $i; ?></a>
                </li>
            <?php endfor; ?>

            <?php if ($page < $totalPages): ?>
                <li class="page-item">
                    <a class="page-link" href="obituaries.php?page=<?php echo ($page + 1) . "&search=" . urlencode($search); ?>">Next</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
