<?php
include 'db_connect.php'; // Make sure this file contains the correct database connection
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($inquiry_type === "General") {
      ...
      $stmt = $conn->prepare("INSERT INTO inquiries (name, email, inquiry_type, message, created_at) VALUES (?, ?, ?, ?, NOW())");
