...
<div class="container mt-5">
    ...
    <div id="obituary_fields" style="display: none;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="deceased_first_name" name="deceased_first_name">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="deceased_last_name" name="deceased_last_name">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="date_of_passing" name="date_of_passing">
        </div>
        <div class="mb-3">
