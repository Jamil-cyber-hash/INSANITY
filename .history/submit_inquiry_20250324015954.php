...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($inquiry_type === "General") {
        ...
        $stmt = $conn->prepare("INSERT INTO obituaries (name, sender_email, deceased_first_name, deceased_middle_name, deceased_last_name, gender, date_of_passing, description, image) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
